...
def main():
    ...
    base_cmd = f"python main.py --weighting {method} --arch HPS --dataset office-home --dataset_path data/office-home --gpu_id 0 --scheduler step --mode train --lr 0.0001 --multi_input"
    ...
    commands = [
        f"{base_cmd} --save_path logs/office-home/{method}/HPS/seed{seed} --seed {seed}" for seed in seed_vals
    ]
